...
<p>Warning: this workshop requires work. In fact, most of the day will be spent working on grids with peer review and critique thrown in for good measure. At the end of the day, you'll know why 12 columns is not always the best grid to use, you'll know the difference between compound grids and modular grids and when to apply them, and – most importantly – you'll have the workflows to start making your own grids from scratch.</p><a href="#" class="cta">Buy Tickets</a>
		...
		<div id="wrk2" class="workshop-item">
			...
			<p>This workshop will help you to construct web sites that will feel natural on a whole range of devices, from mobile phones to tablets, laptops, e-readers and devices we haven’t even thought of yet.</p><a href="#" class="cta">Buy Tickets</a>
